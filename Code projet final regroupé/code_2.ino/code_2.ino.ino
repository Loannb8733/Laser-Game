...
char joueur1[] = "BOULO"; //déclare la variable joueur 1 écrit " Boulo"
...
// ------ Loann BST ------
  ...
  pixels->begin(); // inithialise la librairie NeoPixel

  for(int i=0;i<numPixel;i++){

    pixels->setPixelColor(i, pixels->Color(0,0,255)); // indique que la couleur des LED RGB sont bleu (0,0,255=bleu)
...
void loop() // Programme principal
{
 ...
 if(digitalRead(gachette)== HIGH && boolBouton == 0) // Si appui sur le BP 
      {
          ...
          ///////////// A VOIR //////////////
          lasergun1.sendSony(2000,16); //void sendSony(unsigned long data, int nbits);Envoi du code 4000 sur 16 bits 
          /////////// A VOIR /////////////////
 ...
 //_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
   ...
   if (plastron1.decode(&results)) // Si le plastron reçoit des données alors
   {
      ...
      ////////// A VOIR //////////
      if(results.value == 4000 ) // Si le code reçu est 4000 alors
      ////////// A VOIR /////////
          {
  ...
  SeeedOled.setNormalDisplay();//met le lecteur LCD en mode normale   
   // RALLUMER LE PLASTRON
              pixels->setPixelColor(0, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show();// animation des LED RGB  
              pixels->setPixelColor(1, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(2, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(3, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(4, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(5, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(6, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(7, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(8, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(9, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(10, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(11, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(12, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(13, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(14, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(15, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(16, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(17, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(18, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(19, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(20, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show(); // animation des LED RGB  
              pixels->setPixelColor(21, pixels->Color(0,255,0)); //allume les LED RGB (0,255,0=couleur bleu)
              pixels->show();// animation des LED RGB  
